...
| `verticalOrientation` | `boolean` (from date-dns) | _optional_ | `undefined`       | defines if DateRangePicker will orient itself vertically (caller can set it for for potrait screens) |
